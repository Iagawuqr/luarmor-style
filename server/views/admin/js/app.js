                ...
                switch(page) {
                    ...
                    case 'sessions':
                        if (typeof Sessions !== 'undefined') {
                            content.innerHTML = Sessions.render();
                            Sessions.init();
                        }
                        break;
                    ...
                    case 'suspended':
                        if (typeof Suspended !== 'undefined') {
                            content.innerHTML = Suspended.render();
                            Suspended.init();
                        }
                        break;
    ...
    renderSettings() {
        return `
            ...
            <div class="card" style="margin-top:20px">
                <div class="card-header">
                    <h3 class="card-title">📋 Loader Script</h3>
                </div>
                <div class="card-body">
                    <pre style="background:#1a1a2e;padding:15px;border-radius:8px;overflow-x:auto">
                        <code>loadstring(game:HttpGet("${window.location.origin}/loader"))()</code>
                    </pre>
                    <button class="btn btn-primary" style="margin-top:10px" 
                            onclick="navigator.clipboard.writeText('loadstring(game:HttpGet(&quot;${window.location.origin}/loader&quot;))()');alert('Copied!')">
                        📋 Copy
                    </button>
                </div>
            </div>
