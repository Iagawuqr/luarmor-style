...
// ============ REMOVENDO O app.use('*') PROBLEMÁTICO ============
// app.use('*', (req, res) => {
//     const ct = getClientType(req);
        ...
        return res.status(404).type('html').send(`
            ...
            <body style="background:#0a0a0f;color:#fff;display:flex;justify-content:center;align-items:center;height:100vh;font-family:sans-serif">
                <div style="text-align:center">
                    ...
                    <p style="color:#666">Use the main URL: <a href="/" style="color:#5865F2">${req.protocol}://${req.get('host')}/</a></p>
                </div>
            </body>
            </html>
        `);
    }
    res.status(404).type('text/plain').send('print("❌ 404 - Not Found")');
});
